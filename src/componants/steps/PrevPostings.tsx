  ...
  return (
    <form>
      <h1 className="block text-2xl font-bold text-gray-700">
        Previous postings of {values.f_name}
      </h1>
      ...
      <div className="my-6 grid grid-flow-col auto-cols-max gap-12">
        ...
        <div className="w-96">
          ...
          <input
            ...
            name="service_book"
            accept=".pdf"
            className="border border-black rounded p-1 focus:outline-blue-500 flex w-full "
          ></input>
        </div>
      </div>
      ...
      {institutes.map((institute) => (
        <details
          key={`details-${institute}`}
          open={expandedInstitute === institute}
        >
          <summary
            onClick={(event) => handleSummaryClick(event, institute)}
            className="my-2 text-black text-lg font-bold bg-indigo-300 p-4 rounded-md"
          >{`Details of institute #${institute}`}</summary>
          <div className="p-4 bg-indigo-100 rounded-md">
            {/* Institute name */}
            <div className="mt-4 w-96">
              <label
                htmlFor={`institute_name_${institute}`}
                className="block mb-2 text-base font-bold text-gray-700"
              >{`Institute name #${institute}`}</label>
              <select
                name={`institute_name_${institute}`}
                id={`institute_name_${institute}`}
                value={values[`institute_name_${institute}`] ?? ""}
                onChange={handleSelectChange}
                className="border border-black rounded p-2 focus:outline-blue-500 flex w-full "
              >
                <option value="" disabled>
                ...
                <option value="Kendriya Vidyalaya, Southern Command, Pune">
            ...
            <div className="mt-4 grid grid-cols-3 gap-12">
              <div className="mt-4 w-96">
                <label
                  htmlFor={`post_${institute}`}
                  className="block mb-2 text-base font-bold text-gray-700"
                >{`Post #${institute}`}</label>
                <select
                  name={`post_${institute}`}
                  id={`post_${institute}`}
                  value={values[`post_${institute}`] ?? ""}
                  onChange={handleSelectChange}
                  className="border border-black rounded p-2 focus:outline-blue-500 flex w-full "
                >
                  <option value="" disabled>
              ...
              <div className="mt-4 w-96">
                <label
                  htmlFor={`subject_${institute}`}
                  className="block mb-2 text-base font-bold text-gray-700"
                >{`Subject #${institute}`}</label>
                <select
                  name={`subject_${institute}`}
                  id={`subject_${institute}`}
                  value={values[`subject_${institute}`] ?? ""}
                  onChange={handleSelectChange}
                  className="border border-black rounded p-2 focus:outline-blue-500 flex w-full "
                >
                  <option value="" disabled>
            ...
            <div className="mt-4 grid grid-cols-3 gap-12">
              <div className="mt-4 w-96">
                <label
                  htmlFor={`starting_salary_${institute}`}
                  className="block mb-2 text-base font-bold text-gray-700"
                >{`Starting salary #${institute}`}</label>
                <input
              ...
              <div className="mt-4 w-96">
                <label
                  htmlFor={`ending_salary_${institute}`}
                  className="block mb-2 text-base font-bold text-gray-700"
                >{`Ending salary #${institute}`}</label>
                <input
            ...
            <div className="mt-4 w-96">
              <label
                htmlFor={`remark_${institute}`}
                className="block mb-2 text-base font-bold text-gray-700"
              >{`Remark by authority #${institute}`}</label>
              <input
